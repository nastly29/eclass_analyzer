...
from services.class_diff_service import (
    analyze_internal_changes,
    get_added_classes,
    get_all_deleted_classes,
)
from services.class_mapper_service import get_deleted_classes_with_mapping
from services.metrics_service import (
    generate_segment_statistics,
...
btn_run, files_uploaded, top_k, similarity_threshold, selected_segments = (
    render_sidebar()
)
...
if btn_run:
    ...
    with status_container.container():
        ...
        all_deleted_df = get_all_deleted_classes(data["cc15"], data["cc16"])
        ...
        st.session_state["all_deleted_df"] = all_deleted_df
...
if st.session_state.get("analysis_done"):
    render_dashboard(
        ...
        all_deleted_df=st.session_state.get("all_deleted_df"),
    )
else:
    st.info("Завантажте необхідні датасети на бічній панелі для запуску аналізу.")